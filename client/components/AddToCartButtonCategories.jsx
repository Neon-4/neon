...
const AddToCartButtonCategories = ({ product }) => {
    ...
    const addToCart = () => {
        if (product && quantity > 0) {
            const cartItem = {
                ...
                price: product.price * quantity, // Calculate total price based on quantity
            ...
            router.push(`/cart?addedItemId=${product.id}`);
        }
    };
...
export default AddToCartButtonCategories;
